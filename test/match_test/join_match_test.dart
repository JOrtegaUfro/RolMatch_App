...
void main() {
  ...
  test(
      'Utiliza joinMatch Join() en conjunto a JoinService, y solo se llama una vez al backend, ademas de no presentar un error al recibir respuesta 200',
      () async {
    dio = Dio(BaseOptions(contentType: Headers.jsonContentType));
    dioAdapter = DioAdapter(dio: dio);
    joinService = JoinService(dio: dio);
    JoinMatch joinMatch = JoinMatch(joinService: joinService);
