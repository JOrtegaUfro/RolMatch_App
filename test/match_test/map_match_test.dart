...
void main() {
  ...
  testWidgets('Tests para modelo de mapMatch, setters',
      (WidgetTester tester) async {
    final mapMatch = MapMatch();
    mapMatch.id = 1;
    mapMatch.latitud = 324342.43;
    mapMatch.longitud = 234432.54;
    mapMatch.date = "14-06-2024";
    mapMatch.duration = "60 minutos";
    mapMatch.hora = "20:30";
    mapMatch.type = "Tipo 1";
    mapMatch.totalSlots = 6;
    mapMatch.totalPlayer = 14;
    mapMatch.description = "Una partida Test";
    ...
    expect(mapMatch.totalSlots, 6);
    expect(mapMatch.totalPlayers, 14);
    expect(mapMatch.description, "Una partida Test");
  });
}
